...
#: Mapping of valid GAMS solvers to model types (generated using GAMS 45.1.0)
valid_solvers = {
    ...
    'CPLEXCLASSIC': {'LP', 'MIP', 'RMIP', 'QCP', 'MIQCP', 'RMIQCP'},
    'DE': {'EMP'},
    'DECISC': {'LP'},
    'DECISM': {'LP'},
    'DICOPT': {'MINLP', 'MIQCP'},
    ...
    'GLOMIQO': {'NLP', 'CNS', 'DNLP', 'RMINLP', 'MINLP', 'QCP', 'MIQCP', 'RMIQCP'},
    'GUROBI': {
        'LP',
        'MIP',
        'RMIP',
    ...
    'OCTERACT': {'NLP', 'DNLP', 'RMINLP', 'MINLP', 'QCP', 'MIQCP', 'RMIQCP'},
    'ODHCPLEX': {'MIP', 'MIQCP'},
    'OSICPLEX': {'LP', 'MIP', 'RMIP', 'QCP', 'MIQCP', 'RMIQCP'},
    'OSIGUROBI': {
        'LP',
        'MIP',
        'RMIP',
