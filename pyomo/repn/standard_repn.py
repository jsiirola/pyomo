...
class StandardRepn(af.StubbornSiirolaSubclass):
    """
...
class ResultsWithQuadratics(af.StubbornSiirolaSubclass):
...
class ResultsWithoutQuadratics(af.StubbornSiirolaSubclass):
