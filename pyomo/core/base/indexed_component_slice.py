...
class IndexedComponent_slice(af.StubbornSiirolaSubclass):
...
class _slice_generator(af.StubbornSiirolaSubclass):
...
class _NotIterable(af.StubbornSiirolaSubclass):
    pass


class _IndexedComponent_slice_iter(af.StubbornSiirolaSubclass):
    def __init__(
        self,
        component_slice,
